...
#   refaft = (((vala[TOTA] - alpaft) / betaft)^2.0 + ((valb[TOTA] - alpaft) / betaft)^2.0)^0.5
    ...
    refnow = (((vala[TOTN] - alpnow) / betnow)^2.0 + ((valb[TOTN] - alpnow) / betnow)^2.0)^0.5
  end =#
  if POLY
#   alpbef = lodalpint.minimum[1] * refbef^2 + lodalpint.minimum[2] * refbef + lodalpint.minimum[3]
#   alpaft = lodalpint.minimum[1] * refaft^2 + lodalpint.minimum[2] * refaft + lodalpint.minimum[3]
...
for (a, ref) in enumerate(tars)
  alpo[a,1] = localpint.minimum[1] * ref^2 + localpint.minimum[2] * ref + localpint.minimum[3]
  alpo[a,2] = lodalpint.minimum[1] * ref^2 + lodalpint.minimum[2] * ref + lodalpint.minimum[3]
  beto[a,1] = locbetint.minimum[1] * ref^2 + locbetint.minimum[2] * ref + locbetint.minimum[3]
  beto[a,2] = lodbetint.minimum[1] * ref^2 + lodbetint.minimum[2] * ref + lodbetint.minimum[3]
  sigo[a,1] = locsigint.minimum[1] * ref^2 + locsigint.minimum[2] * ref + locsigint.minimum[3]
  sigo[a,2] = lodsigint.minimum[1] * ref^2 + lodsigint.minimum[2] * ref + lodsigint.minimum[3]
  coro[a,1] = loccorint.minimum[1] * ref^2 + loccorint.minimum[2] * ref + loccorint.minimum[3]
