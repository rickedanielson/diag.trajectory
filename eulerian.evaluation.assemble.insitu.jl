#=
 ...
 = interest, write the corresponding subset of observations - RD April 2016.
 =#

using My

if (argc = length(ARGS)) != 2
  print("\nUsage: jjj $(basename(@__FILE__)) buoydata_1993_2014_drogON.asc.nonmdt buoydata_1993_2014_drogON.asc.nonmdt.locate_2.0_valid_remainder\n\n")
  exit(1)
end
